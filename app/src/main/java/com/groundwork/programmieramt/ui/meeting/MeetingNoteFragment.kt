...
import com.groundwork.programmieramt.databinding.FragmentMeetingNoteBinding
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.coroutines.launch

@AndroidEntryPoint
class MeetingNoteFragment : Fragment() {

    private var _binding: FragmentMeetingNoteBinding? = null
    private val binding get() = _binding!!
    private val viewModel: MeetingNoteViewModel by viewModels()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentMeetingNoteBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = MeetingNoteAdapter(
            onClick = { note ->
                findNavController().navigate(
                    R.id.action_meeting_to_detail,
